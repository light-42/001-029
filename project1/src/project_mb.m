...
set(handles.pushbutton_filtering,'enable','off');
set(handles.pushbutton_amplify,'enable','off');
set(handles.pushbutton_PickPoints,'enable','off');
...
stop(t);
delete(t);
set(handles.pushbutton_PickPoints,'enable','on');
...
set(handles.pushbutton_filtering,'enable','on');
set(handles.pushbutton_amplify,'enable','on');
